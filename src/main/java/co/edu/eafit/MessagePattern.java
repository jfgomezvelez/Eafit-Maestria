...
public class MessagePattern {
    ...
    @RabbitListener(bindings = @QueueBinding(value = @Queue(value = "weather.service.cm.queue"),
            exchange = @Exchange(value = "weather.service.cm.exchange"),
            key = "weather.service.cm.routingkey"),
